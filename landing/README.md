...
The landing page goes on vinish.dev. VinAura is free: every "Get VinAura PDF" button leads to the GitHub section, which opens https://github.com/devvinish/pdfgen-apex.
...
3. **Cache.** LiteSpeed Cache > Purge All.
4. **Test.** Open the live page and try the buttons and the pictures.
...
- No plugin is needed: the page has no form.
